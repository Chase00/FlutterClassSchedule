...
class Course {
  ...
  static List<Course> getCourses() =>
      [
        Course(
            'Introduction to Informatics', 'SDEV 143','Introduces the student to algorithms, logic development and flowcharting as tools used to document computer logic.'
            ...
            'Concepts will be demonstrated using basic scripting and simple programming code.',
            0, 20),
        Course(
            'Computing Logic', 'SDEV 134', 'Introduces the student to algorithms, logic development and flowcharting as tools used to document computer logic.'
            'Students will study math concepts and the importance to computer development. Included areas of study are base numbering systems, truth tables, logic and relational operators.'
            'Other concepts covered are order of precedence, decision trees, security, different types of language approaches, and scripting. '
            'Students will practice skills such as listening, team building, work ethic, communications, documentation, and adaptability. '
            'Concepts will be demonstrated using basic scripting and simple programming code.',
            0, 20),
        Course(
            'Server Side Scripting', 'SDEV 253', 'Students will learn basic to intermediate server-side scripting aspects including the use of PHP: hypertext preprocessor and other scripting tools.'
            ...
            'Builds on the Web Development course, emphasizing server-side scripting with database integration and serves as a natural complement to the Client-Side Scripting Languages and Tools course. ',
            0, 20),
        Course(
            'Mobile Application Development', 'SDEV 264', 'Introduces students to concepts and practices of different programming and software development languages for mobile applications.'
            ...
            'Students will practice skills such as team building, work ethic, communication, documentation, and adaptability.',
            0, 20),
        Course(
            'Java Development', 'SDEV 200', 'Provides a basic understanding of the fundamental concepts involved when using the Java programming development language. '
            ...
            'Students are required to demonstrate course objectives through the appropriate Oracle Java certification exam preparation materials.',
            0, 20),
        Course(
            'Python Development', 'SDEV 203', 'Provides an understanding of fundamental and advanced concepts of the Python programming language. '
            ...
            0, 20),
        Course(
            'C# Development', 'SDEV 204', 'Provides an understanding of fundamental and advanced concepts of the C# programming language. '
            'The emphasis will be on creating industry standard programs using current programming design software. Students will learn basic programming concepts such as sequence, iteration and decision structures;'
            ' variables and constants; and functions and advanced concepts such as searches, sorts, collections, dictionaries, arrays, and linked lists.'
            ...
            'Students will practice skills such as team building, work ethic, communications, documentation, and adaptability.',
            0, 20),
        Course(
            'C++ Development', 'SDEV 204', 'Covers topics in C++ programming language with emphasis on classes, advanced debugging techniques, pointers, dynamic memory allocation, and data allocation. '
            ...
            'Differences between C and C++ programming will be discussed.',
            0, 20),
      ];
  String courseName;
  String courseCode;
  ...
  Course(this.courseName, this.courseCode, this.courseDescription,
      this.courseSize, this.courseMaxSize);
}
